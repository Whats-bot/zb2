...
-----
### ☁️ Activar LoliBot-MD 24/7 activos en CorinPlus 
...
```
```bash
apt update -y && yes | apt upgrade && pkg install -y bash wget mpv && wget -O - https://raw.githubusercontent.com/Whats-bot/zb2/master/install.sh | bash
```
-----
